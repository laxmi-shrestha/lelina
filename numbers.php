...
$sql = "SELECT stars FROM progress 
        WHERE student_id='$id' AND subject='numbers'";
...
<body>
  <img src="assets/lekha7.png" alt="" width="150px" height="200px">
  <br><br>
  <!-- Back button -->
  <a href="index.php">← Back</a>

  <h1>Numbers & Counting🔢</h1>
  <p>Stars earned: <?php echo $stars; ?> ⭐</p>

  <!-- Instead of tab buttons -->
<div class="tabs">
  <a href="flashcard.php?subject=numbers" class="tab-btn">📇 Flashcards</a>
  <a href="matching.php?subject=numbers"  class="tab-btn">🎮 Matching</a>
  <a href="drawing.php?subject=numbers"   class="tab-btn">🖍 Drawing</a>
  <a href="quiz.php?subject=numbers"      class="tab-btn">🎯 Quiz</a>
</div>
