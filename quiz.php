...
$quizData = [
  ...
  'body' => [
    ['question'=>'👁️ is which body part?',  'options'=>['Eye','Nose','Ear','Mouth'],     'answer'=>'Eye'],
    ['question'=>'👃 is which body part?',  'options'=>['Eye','Nose','Ear','Hand'],      'answer'=>'Nose'],
    ['question'=>'👂 is which body part?',  'options'=>['Eye','Nose','Ear','Foot'],      'answer'=>'Ear'],
    ['question'=>'✋ is which body part?',  'options'=>['Hand','Foot','Ear','Nose'],     'answer'=>'Hand'],
    ['question'=>'🦶 is which body part?',  'options'=>['Hand','Foot','Eye','Mouth'],    'answer'=>'Foot'],
    ['question'=>'👄 is which body part?',  'options'=>['Mouth','Nose','Ear','Eye'],     'answer'=>'Mouth'],
    ['question'=>'🦷 is which body part?',  'options'=>['Teeth','Hand','Tongue','Bone'], 'answer'=>'Teeth'],
    ['question'=>'Which part do we hear with?', 'options'=>['Eye','Ear','Nose','Hand'],  'answer'=>'Ear'],
    ['question'=>'Which part do we see with?',  'options'=>['Eye','Ear','Nose','Hand'],  'answer'=>'Eye'],
    ['question'=>'Which part do we walk with?', 'options'=>['Hand','Foot','Eye','Ear'],  'answer'=>'Foot'],
],

'barakhadi' => [
    ['question'=>'का is which sound?',  'options'=>['ka','kaa','ki','ku'],   'answer'=>'kaa'],
    ['question'=>'कि is which sound?',  'options'=>['ka','kaa','ki','ku'],   'answer'=>'ki'],
    ['question'=>'कु is which sound?',  'options'=>['ka','kaa','ki','ku'],   'answer'=>'ku'],
    ['question'=>'के is which sound?',  'options'=>['ke','ko','kau','kan'],  'answer'=>'ke'],
    ['question'=>'को is which sound?',  'options'=>['ke','ko','kau','kan'],  'answer'=>'ko'],
    ['question'=>'खा is which sound?',  'options'=>['kha','khaa','khi','khu'],'answer'=>'khaa'],
    ['question'=>'गा is which sound?',  'options'=>['ga','gaa','gi','gu'],   'answer'=>'gaa'],
    ['question'=>'घा is which sound?',  'options'=>['gha','ghaa','ghi','ghu'],'answer'=>'ghaa'],
    ['question'=>'Which is "का"?',      'options'=>['क','का','कि','की'],    'answer'=>'का'],
    ['question'=>'Which is "कि"?',      'options'=>['क','का','कि','की'],    'answer'=>'कि'],
],

'domestic' => [
    ['question'=>'🐄 is which animal?',   'options'=>['Cow','Goat','Sheep','Dog'],     'answer'=>'Cow'],
    ['question'=>'🐐 is which animal?',   'options'=>['Cow','Goat','Sheep','Pig'],     'answer'=>'Goat'],
    ['question'=>'🐕 is which animal?',   'options'=>['Cat','Dog','Horse','Duck'],     'answer'=>'Dog'],
    ['question'=>'🐈 is which animal?',   'options'=>['Cat','Dog','Pig','Goat'],       'answer'=>'Cat'],
    ['question'=>'🐴 is which animal?',   'options'=>['Cow','Horse','Buffalo','Camel'],'answer'=>'Horse'],
    ['question'=>'🦆 is which animal?',   'options'=>['Chicken','Duck','Goat','Pig'],  'answer'=>'Duck'],
    ['question'=>'🐖 is which animal?',   'options'=>['Pig','Cow','Sheep','Dog'],      'answer'=>'Pig'],
    ['question'=>'Which animal says Moo?',  'options'=>['Cow','Goat','Sheep','Horse'], 'answer'=>'Cow'],
    ['question'=>'Which animal says Woof?', 'options'=>['Cat','Dog','Duck','Cow'],     'answer'=>'Dog'],
    ['question'=>'Which animal says Meh?',  'options'=>['Goat','Cow','Dog','Cat'],     'answer'=>'Goat'],
],

'wild' => [
    ['question'=>'🦁 is which animal?',     'options'=>['Lion','Tiger','Bear','Fox'],     'answer'=>'Lion'],
    ['question'=>'🐯 is which animal?',     'options'=>['Lion','Tiger','Bear','Fox'],     'answer'=>'Tiger'],
    ['question'=>'🐻 is which animal?',     'options'=>['Lion','Tiger','Bear','Fox'],     'answer'=>'Bear'],
    ['question'=>'🦊 is which animal?',     'options'=>['Fox','Wolf','Zebra','Giraffe'],  'answer'=>'Fox'],
    ['question'=>'🦒 is which animal?',     'options'=>['Zebra','Giraffe','Rhino','Hippo'],'answer'=>'Giraffe'],
    ['question'=>'🦓 is which animal?',     'options'=>['Zebra','Giraffe','Rhino','Hippo'],'answer'=>'Zebra'],
    ['question'=>'🐊 is which animal?',     'options'=>['Snake','Crocodile','Eagle','Wolf'],'answer'=>'Crocodile'],
    ['question'=>'Which animal Roars?',     'options'=>['Lion','Fox','Zebra','Giraffe'],  'answer'=>'Lion'],
    ['question'=>'Which animal has stripes?','options'=>['Zebra','Elephant','Hippo','Bear'],'answer'=>'Zebra'],
    ['question'=>'🐘 is which animal?',     'options'=>['Rhino','Hippo','Elephant','Bear'],'answer'=>'Elephant'],
],

'water' => [
    ['question'=>'🐟 is which animal?',    'options'=>['Fish','Shark','Crab','Frog'],     'answer'=>'Fish'],
    ['question'=>'🦈 is which animal?',    'options'=>['Fish','Shark','Whale','Octopus'], 'answer'=>'Shark'],
    ['question'=>'🐬 is which animal?',    'options'=>['Whale','Dolphin','Shark','Seal'], 'answer'=>'Dolphin'],
    ['question'=>'🐳 is which animal?',    'options'=>['Whale','Dolphin','Shark','Turtle'],'answer'=>'Whale'],
    ['question'=>'🐙 is which animal?',    'options'=>['Octopus','Squid','Crab','Lobster'],'answer'=>'Octopus'],
    ['question'=>'🦀 is which animal?',    'options'=>['Crab','Lobster','Octopus','Turtle'],'answer'=>'Crab'],
    ['question'=>'🐢 is which animal?',    'options'=>['Turtle','Frog','Seal','Crab'],     'answer'=>'Turtle'],
    ['question'=>'🐸 is which animal?',    'options'=>['Frog','Turtle','Fish','Crab'],     'answer'=>'Frog'],
    ['question'=>'Which animal lives in shell?', 'options'=>['Crab','Fish','Dolphin','Whale'],'answer'=>'Crab'],
    ['question'=>'Biggest water animal?',  'options'=>['Fish','Whale','Crab','Frog'],      'answer'=>'Whale'],
],
  'animals' => [
