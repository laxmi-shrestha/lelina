...
$sql = "SELECT stars FROM progress 
        WHERE student_id='$id' AND subject='abc'";
...
<html>
<head>
  <title>ABC & Letters 🔤</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <img src="assets/lekha2.png" alt="" width="150px" height="200px">
  <br><br>
  <!-- Back button -->
...
<div class="tabs">
  <a href="flashcard.php?subject=abc" class="tab-btn">📇 Flashcards</a>
  <a href="matching.php?subject=abc"  class="tab-btn">🎮 Matching</a>
  <a href="drawing.php?subject=abc"   class="tab-btn">🖍 Drawing</a>
</div>
