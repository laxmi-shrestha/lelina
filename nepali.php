...
$sql = "SELECT stars FROM progress 
        WHERE student_id='$id' AND subject='nepali'";
...
<html>
<head>
  <title>नेपाली वर्णमाला</title>
  <link rel="stylesheet" href="style.css">
</head>
<body>
  <img src="assets/lekha4.png" alt="" width="150px" height="200px">
  <br><br>
  <!-- Back button -->
...
<div class="tabs">
  <a href="flashcard.php?subject=nepali" class="tab-btn">📇 Flashcards</a>
  <a href="matching.php?subject=nepali"  class="tab-btn">🎮 Matching</a>
  <a href="drawing.php?subject=nepali"   class="tab-btn">🖍 Drawing</a>
  <a href="quiz.php?subject=nepali"      class="tab-btn">🎯 Quiz</a>
</div>
