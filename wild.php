...
$sql = "SELECT stars FROM progress 
        WHERE student_id='$id' AND subject='wild'";
...
<body>
  <img src="assets/lekha10.png" alt="" width="150px" height="200px">
  <br><br>
  <!-- Back button -->
...
<div class="tabs">
  <a href="flashcard.php?subject=wild" class="tab-btn">📇 Flashcards</a>
